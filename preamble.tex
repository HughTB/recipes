...
\titleformat{\chapter}[display]
  {\normalfont\bfseries\Huge\centering}{\vspace{-70pt}}{0pt}{}

\newcommand{\difficulty}[1]{
  \foreach \x in {1,...,5}{\ifnumgreater{\x}{#1}{\faStar[regular]}{\faStar}}
}
...
\newcommand{\recipe}[7]{
  ...
  \begin{center}
    \begin{tabular}{ p{0.15\linewidth} p{0.15\linewidth} p{0.15\linewidth} p{0.15\linewidth} }
      \centering{\faClock[regular]\ Time\\#2} &
      \centering{\faLeaf\ Diet\\#3} &
      \centering{\faStarHalf*\ Difficulty\\\difficulty{#4}} &
